document.addEventListener('DOMContentLoaded', () => {
    ...
    if (skillsGrid) {
        ...
        tooltip.style.cssText = `
            ...
            font-size: 14px; line-height: 1.5; z-index: 1000; pointer-events: none;
        ...
        skillsData.forEach(skill => {
            ...
            skillItem.addEventListener('mousemove', positionTooltip);
