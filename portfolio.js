document.addEventListener('DOMContentLoaded', () => {
    ...
    const projectsList = [
        ...
        { name: "URL Path Separator", description: "It's a handy tool that simplifies splitting and managing URL paths by accurately identifying and separating each segment, making navigation more efficient.", image: "https://i.ibb.co/5xBWW6mJ/URL-Path-Separator.png", link: "https://shakeeb-sa.github.io/url-path-separator.html", code: "https://github.com/shakeeb-sa/home", slug: "alcohol101-plus", type: "Personal Project" },
        ...
        { name: "Guestbook Extractor Chrome Extension", description: "A Chrome extension that automates scrolling through guest books, downloads backlinks, and removes duplicates for efficient link building.", image: "https://i.ibb.co/cMR4CKV/Guestbook-Extractor-Chrome-Extension.jpg", link: "https://shakeeb-sa.github.io/guestbook-extractor-chrome-extension.html", code: "https://github.com/shakeeb-sa/home", slug: "responsibility-works", type: "Personal Project" },
        { name: "All About Coding", description: "Discover a comprehensive collection of coding tutorials, videos, and resources from YouTube. Your go-to site for all things coding—learn, explore, and master programming today!", image: "https://i.ibb.co/LzXTHdkY/All-About-Coding.jpg", link: "https://shakeeb-sa.github.io/all-about-coding.html", code: "https://github.com/shakeeb-sa/home", slug: "safe-drive", type: "Personal Project" },
